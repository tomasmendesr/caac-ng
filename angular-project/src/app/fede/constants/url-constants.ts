export class UrlConstantsCaac {
  ...
  public static readonly SAVE_OR_UPDATE_VENCIMIENTO = '/services/vencimiento/saveOrUpdate';
  public static readonly FIND_ALL_CASAS_CON_PAGOS = '/services/casa/findAllConPagos';
